...
//    public ResponseEntity<?> handleResourceNotFoundException(BoardNotFoundException rnfe, HttpServletRequest request) {
//
...
//    }
//
//    @ExceptionHandler(DuplicateKeyRegistry.class)
//    public ResponseEntity handleDuplicateKeyException(DuplicateKeyRegistry ex) {
//        ErrorDetail errorDetail = new ErrorDetail();
//        errorDetail.setTimeStamp(new Date().getTime());
//        errorDetail.setStatus(HttpStatus.CONFLICT.value());
//        errorDetail.setTitle("Registro Duplicado");
